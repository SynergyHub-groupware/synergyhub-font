...
export const {approval: {getFormdetail, getForms, getLines, getLineemps, getSuccess, resetSuccess, getContent, getDocuments, getViewlines, resetContent, getBoxes, getAttaches, resetAttaches, getOnedoc, resetOnedoc}} = createActions({
