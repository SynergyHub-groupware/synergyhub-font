...
function Line({handleTrueLineList, docInfo = {}}){
    let myRole = '';
    ...
    return(
        <>
            ...
            <LineApprover lsCode={lsCode} lines={lines} employee={employee} handleTrueLineList={handleTrueLineList} docInfo={docInfo}/>
        </>
    )
}
export default Line;